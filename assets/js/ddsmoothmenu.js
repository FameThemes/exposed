			...
			function(e){
				...
				$targetul.data('timers').showtimer=setTimeout(function(){
					...
					if ($targetul.queue().length<=1){ //if 1 or less queued animations
						...
						$targetul.css({left:-((header._dimensions.subulw - header._dimensions.w + 0)/2) +"px", width:header._dimensions.subulw+'px'}).animate({height:'show',opacity:'show'}, ddsmoothmenu.transition.overtime)
