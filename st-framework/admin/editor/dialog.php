...
<!-- <form onsubmit="insertLink();return false;" action="#"> -->
    ...
    <div class="st_shortcode_inner panel_wrapper" style="overflow: auto; height: 100%; overflow: auto;">
		...
		<div id="columns_panel" class="panel" >
    		  ...
    		  <div class="tab_content">
                    <button class="btn" onclick='insertStshorcode("<br/>[row]<br/>[col width=\"three\"] COLUMN_1_CONTENT [/col] <br/>[col width=\"three\"] COLUMN_2_CONTENT [/col] <br/>[col width=\"three\"] COLUMN_3_CONTENT [/col] <br/>[col width=\"three\"] COLUMN_4_CONTENT [/col] <br/>[/row] <br/>");' ><?php _e('4 Columns','smooththemes'); ?></button>
                    <button class="btn" onclick='insertStshorcode("<br/>[row]<br/>[col width=\"four\"] COLUMN_1_CONTENT [/col] <br/>[col width=\"four\"] COLUMN_2_CONTENT [/col] <br/>[col width=\"four\"] COLUMN_3_CONTENT [/col] <br/>[/row] <br/>");' ><?php _e('3 Columns','smooththemes'); ?></button>
                    <button class="btn" onclick='insertStshorcode("<br/>[row]<br/>[col width=\"six\"] COLUMN_1_CONTENT [/col] <br/>[col width=\"six\"] COLUMN_2_CONTENT [/col] <br/>[/row] <br/>");' ><?php _e('2 Columns','smooththemes'); ?></button>
                    <button class="btn" onclick='insertStshorcode("<br/>[row]<br/>[col width=\"twelve\"] COLUMN_1_CONTENT [/col] <br/>[/row] <br/>");' ><?php _e('1 Column','smooththemes'); ?></button>     
