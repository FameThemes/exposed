...
jQuery(document).ready(function () {
    ...
    jQuery('.stbuilder select[multiple=multiple]').each(function () {
        var s = jQuery(this);
    ...
    /* when select page template   */
    function page_template_changed() {
        if (jQuery('select#page_template').length) {
            var file_name = jQuery('select#page_template').val();
            if (typeof(file_name) == 'undefined') {
                file_name = '';
            }
            switch (file_name) {
                case 'tpl-fullscreen.php':
                    jQuery('.dynamic-item').hide();
                    jQuery('.tpl-fullscreen').show();
                    break;
                case 'tpl-full-width.php':
                    jQuery('.dynamic-item').hide();
                    jQuery('.tpl-full-width').show();
                    break;
                default:
                    jQuery('.dynamic-item').hide();
                    jQuery('.default').show();
    ...
    }// end function page_template_changed
